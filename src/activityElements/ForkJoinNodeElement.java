...
public class ForkJoinNodeElement extends ActivityNodes {

	protected String incomingName;
	protected String outgoingName;
	
	public ForkJoinNodeElement(String type, String id, String inPartition,
	...
	public double compareTo(PackagedElement packagedElement) {
		...
		double mark=0;
		if (packagedElement instanceof ForkJoinNodeElement) {
			ForkJoinNodeElement student = (ForkJoinNodeElement)packagedElement;
