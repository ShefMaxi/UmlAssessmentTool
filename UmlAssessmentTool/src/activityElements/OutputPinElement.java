...
public class OutputPinElement extends ActivityNodes {

protected String outgoingName;
	
	public OutputPinElement(String type, String id, String inPartition,
	...
	public double compareTo(PackagedElement packagedElement) {
		...
		double mark=0;
		if (packagedElement instanceof OutputPinElement) {
			OutputPinElement student = (OutputPinElement)packagedElement;
