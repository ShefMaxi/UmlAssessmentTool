...
public class TimeEventElement extends ActivityNodes {

protected String outgoingName;
	
	public TimeEventElement(String type, String id, String inPartition,
	...
	public double compareTo(PackagedElement packagedElement) {
		...
		double mark=0;
		if (packagedElement instanceof TimeEventElement) {
			TimeEventElement student = (TimeEventElement)packagedElement;
